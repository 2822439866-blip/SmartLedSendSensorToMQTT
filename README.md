...
Overall Architecture：
	...
	框架图："C:\Users\13257\Desktop\my_project\架构图.png"
	main应用层:包含 wifiManager 与 mqttManager，负责通信
	device 硬件驱动层： 包含 Sensor、MPU6050、Button 以及 SmartLed  led_breath (PWM) 等底层硬件控制
--------------------------------------------------------------------------------------------Task and Data Flow：为了更清晰地展示系统的底层数据运行机制，本项目的逻辑流转分为“业务宏观视角”与“底层代码视角”两层：
	1.业务视角："C:\Users\13257\Desktop\my_project\SmartLedSendSensorToMQTTexternC\任务与数据流向图（业务视角）.png"
	...
	2.代码与底层视角："C:\Users\13257\Desktop\my_project\SmartLedSendSensorToMQTTexternC\任务与数据流向图（代码视角）.png"
...
--------------------------------------------------------------------------------------------系统核心状态机设计与工作流程/逻辑：
	"C:\Users\13257\Desktop\my_project\SmartLedSendSensorToMQTTexternC\系统状态逻辑.png"
...
Module Details：
	...
	wifiManager / mqttManager: 封装了 ESP-IDF 的 WiFi 和 MQTT 客户端逻辑，包含 NVS 初始化、事件回调注册以及自动重连机制。
...
我模拟了开机正常运行后停止移动1，停止移动设备 感知到静止状态开启开启低功耗模式2，断开网络3，开启网络设备回复正常的运行逻辑4
	...
	1：非低功耗模式："C:\Users\13257\Desktop\my_project\运行截图与 MQTT 截图\2378920291a4a0ce34216d20c1b424f0.png"
	"C:\Users\13257\Desktop\my_project\运行截图与 MQTT 截图\屏幕截图 2026-06-25 154205.png"（前半部分）

	2：低功耗模式："C:\Users\13257\Desktop\my_project\运行截图与 MQTT 截图\屏幕截图 2026-06-25 153500.png"
	"C:\Users\13257\Desktop\my_project\运行截图与 MQTT 截图\屏幕截图 2026-06-25 154205.png"

	3：断开网络："C:\Users\13257\Desktop\my_project\运行截图与 MQTT 截图\屏幕截图 2026-06-25 153618.png"

	4：恢复网络："C:\Users\13257\Desktop\my_project\运行截图与 MQTT 截图\屏幕截图 2026-06-25 153732.png"
--------------------------------------------------------------------------------------------
Project Highlights：
	基于c++面向对象的系统架构设计：
...
未来优化方向：
	...
	架构重构与代码优化：
		Application类与taskManager类解耦与事件驱动：在taskManager类中强引用了Application.h,包含了整个系统，导致taskManager繁重，所以我在未来可能会使用esp_event 自定义事件循环，解耦Application类与taskManager类
		MQTT数据流调度模型重构：当下是sensorlist_task中光感数据发送到queue，在MQTTpublshTask异步接收，若系统低功耗模式下，存在生产者与消费者之间的速率不匹配问题，目前仅仅是清除过去数据，虽然保证数据时效性，但数据处理与业务逻辑存在部分耦合。所以我在未来可能会使用环形缓冲区或专用的覆盖式队列将“丢弃旧数据、只发最新数据”的策略从业务逻辑中解耦出来，让Application 的业务层更专注于传感器数据的处理，提升架构的可测试性与代码复用度。	
